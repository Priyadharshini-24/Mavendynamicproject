...
<body style="background-image:url(images/Time2.jpg)";>
    ...
    <nav>
        ...
        <a href="addtask.html"><img src="images/addtask.jpg" alt="addtask"width="42px" height="42px" title="Add Task"></a>
    ...
    <br><br>
    <div>
    <a href="EnterTimesheet.html">Enter Timesheet</a> 
    <a href="EditTimesheet.html">Edit Timesheet</a>
    <a href="Timesheetstatus.html">Timesheet Status</a>
